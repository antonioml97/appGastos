...
const summaryCards = computed(() => [
    ...
    { label: 'Ahorro', value: formatCurrency(balance.value), icon: '☆', badgeClass: 'border-teal-400/25 bg-teal-400/10 text-teal-300', accentClass: balancePositive.value ? 'text-teal-300' : 'text-rose-400', captionLead: balancePositive.value ? '↑' : '↓', caption: 'este mes', waveClass: 'bg-[linear-gradient(170deg,transparent_45%,rgba(45,212,191,.12)_46%)]' },
