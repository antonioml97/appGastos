...
const summaryCards = computed(() => [
    ...
    { label: 'Ahorro', value: formatCurrency(localState.value.summary?.totalAhorrado), icon: '☆', badgeClass: 'border-teal-400/25 bg-teal-400/10 text-teal-300', accentClass: 'text-teal-300', captionLead: '↑', caption: 'categoría este mes', waveClass: 'bg-[linear-gradient(170deg,transparent_45%,rgba(45,212,191,.12)_46%)]' },
