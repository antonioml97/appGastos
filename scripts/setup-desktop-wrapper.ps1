param(
    [string]$WrapperPath = (Join-Path $PSScriptRoot '..\platforms\desktop')
)
...
$wrapperRoot = (Resolve-Path $WrapperPath).Path
...
Write-Host "Desktop wrapper preparado en $wrapperRoot"
